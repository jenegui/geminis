<?php
/*
 * File: xajaxResponseManager.inc.php Contains the xajaxResponseManager class Title: xajaxResponseManager class Please see <copyright.inc.php> for a detailed description, copyright and license information.
 */
...
final class xajaxResponseManager {
    /*
     * Object: objResponse The current response object that will be sent back to the browser once the request processing phase is complete.
     */
    private $objResponse;
    ...
    /*
     * Function: xajaxResponseManager Construct and initialize the one and only xajaxResponseManager object.
     */
    ...
    /*
     * Function: getInstance Implementation of the singleton pattern: provide a single instance of the <xajaxResponseManager> to all who request it.
     */
    ...
    /*
     * Function: configure Called by the xajax object when configuration options are set in the main script. Option values are passed to each of the main xajax components and stored locally as needed. The <xajaxResponseManager> will track the characterEncoding and outputEntities settings. Parameters: $sName - (string): Setting name $mValue - (mixed): Value
     */
    ...
    /*
     * Function: clear Clear the current response. A new response will need to be appended before the request processing is complete.
     */
    ...
    /*
     * Function: debug Appends a debug message on the end of the debug message queue. Debug messages will be sent to the client with the normal response (if the response object supports the sending of debug messages, see: <xajaxResponse>) Parameters: $sMessage - (string): The text of the debug message to be sent.
     */
    ...
    /*
     * Function: send Prints the response object to the output stream, thus sending the response to the client.
     */
