...
<body>
	...
	<p>
		<em>This tests what happens when there's whitespace before the
			&lt;?php token in the PHP file (thus possibly causing the XML
	...
	<form id="testForm1" onsubmit="return false;">
		<p>
			<input type="submit" value="Test Whitespace"
				onclick="xajax_showOutput(); return false;" />
		</p>
	</form>
