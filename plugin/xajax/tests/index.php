...
<body>
	...
	<ul>
		<li><a href="xajaxResponseTest.php">xajaxResponse Test</a> (<b>generates
				a new xajax.js file if missing</b>)</li>
		...
		<li><a href="fluentInterfaceTest.php">Fluent Interface Test (PHP 5+
				only)</a></li>
		...
		<li><a href="includeExternalScriptTest.php">Include External Script
				Test</a></li>

		<li><a href="largeResponseTest.php">Large Response Test</a></li>

		<li><a href="nonXajaxResponseTest.php">Non-xajaxResponse XML and Text
				Responses Test</a></li>
		...
		<li><a href="registerExternalFunctionTest.php">Register External
				Function Test</a></li>
