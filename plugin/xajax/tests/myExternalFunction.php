...
?>
<p>This is some content that should be ignored by an asynchronous
	request through xajax, but will show up if the file is otherwise
	included into the script.</p>