...
<body>
	...
	<form id="testForm1" onsubmit="return false;">
		<p>
			<input type="submit" value="Call External Function"
				onclick="xajax_myExternalFunction(); return false;" />
		</p>

		<p>
			<input type="submit" value="Call External Class Method"
				onclick="xajax_myFunction(); return false;" />
		</p>
	</form>
