...
<body>
	...
	<p>
		<a href="#"
			onclick="xajax.request({xjxfun:'saySomething'});return false;">Say
			Something</a>
	...
	<form id="testForm1" onsubmit="return false;">
		...
		<p>
			<input type="submit" value="Form Call with Overridden Callback"
		...
		<p>
			<input type="submit" value="Test onExpiration"
