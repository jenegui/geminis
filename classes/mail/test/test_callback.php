...
<?php
/*
 * This is a sample callback function for PHPMailer Lite. This callback function will echo the results of PHPMailer processing.
 */
...
function callbackAction($result, $to, $cc, $bcc, $subject, $body) {
    /*
     * this callback example echos the results to the screen - implement to post to databases, build CSV log files, etc., with minor changes
     */
